...
- Drag the colored `X`, `Y`, or `Z` gizmo handle to move the selected object with one undoable history transaction; hold `Ctrl` to snap the active axis to the `0.5` grid.
